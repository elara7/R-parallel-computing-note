---
title: "R-parallel-computing-example"
author: "Zexian Wang"
date: "2017-5-31"
...
# 2. Packages(Explicit parallelism)

## 2.1. Modify the funciton
...
### 2.2.3. Do the parallel compution using clusterApply/parLapply
...
### 2.2.5. Stop the parallel environment
...
### 2.3.3. Do the parallel compution using foreach and %dopar%
...
### 2.3.5. Stop the parallel environment
