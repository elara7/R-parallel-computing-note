...
In fact I am not recommend parallel package rather than foreach. Usually foreach is slower than parallel.
...
singlefun <- function(i){solve.quad.eq(a[i],b[i],c[i])}

# do parallel
res1.for <- foreach(i = 1:len) %dopar% singlefun(i)
